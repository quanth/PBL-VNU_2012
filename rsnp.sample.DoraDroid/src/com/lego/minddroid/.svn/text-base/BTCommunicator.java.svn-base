...
/* Chau modified to temporarily remove mResources, replaced by literal strings, 
 * hope to bring it back as soon as figure out how to do getResources() from Motion_profile_impl*/ 
            ...
            try {
                ...
                if (myOwner.isPairing()) {
                    if (uiHandler != null) {
                        ...
                        sendToast("After pairing, press menu and connect.");
