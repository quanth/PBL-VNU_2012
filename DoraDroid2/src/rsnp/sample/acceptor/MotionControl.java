/* 
Chau modified to remove communication with UI. 
Reason: a MotionControl object must be placed inside a Motion_profile_impl, 
from which we found no way to obtain a UI handler. Trying to replace UI communication with exceptions.
*/
 ...
 */
public class MotionControl extends Thread {
    ...
    public MotionControl(BTConnectable myOwner, Handler uiHandler, BluetoothAdapter btAdapter) {
    ...
    public void createNXTconnection() throws IOException {
        try {
            ...
            if (nxtDevice == null) {
            	System.out.println("createNXTconnection: "+mResources.getString(R.string.no_paired_nxt));
            ...
            try {
                ...
                if (myOwner.isPairing()) {
                	System.out.println("createNXTconnection: "+ mResources.getString(R.string.pairing_message));
    ...
    public void destroyNXTconnection() {//throws IOException {
        try {
            ...
            System.out.println("destroyNXTconnection: "+ mResources.getString(R.string.problem_at_closing));
        }
    }
    ...
    private void sendBundle(Bundle myBundle) {
        ...
        System.out.println("SendBundle: "+myMessage);
    }
